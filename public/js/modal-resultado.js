...
window.abrirModalResultado = function ({ venceu, tempoSegundos, palavrasSecretas, proximoLink, proximoTexto, proximoAcao }) {
    ...
    document.getElementById('modal-titulo').textContent = venceu ? '🎉 Você venceu!' : '😔 Não foi dessa vez';
...
function fecharModalResultado() {
    ...
    document.getElementById('fechar-modal-resultado').blur(); // tira o foco do botão
